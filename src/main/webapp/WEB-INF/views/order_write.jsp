    ...
    <div id="main-wrapper">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-primary">주문/결제</h3> </div>
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">장바구니</a></li>
                    <li class="breadcrumb-item active"><strong>주문결제</strong></li>
                </ol>
            </div>
        </div>
        <!-- End Bread crumb -->
                ...
                <div class="col-lg-8">
                    <div class="card card-outline-info">
                        <div class="card-header">
                            <h3 class="m-b-0 text-white">주문서 작성</h3>
                        </div>
                        <div class="card-body">
						    ...
						    <div class="btn-group" role="group" aria-label="divOrdAddr" id="divOrdAddr">
						      <button type="button" class="btn btn-info" onclick="javascript:selectedDelvTab('E')">최근 배송지</button>
						      <button type="button" class="btn btn-default btn-outline" onclick="javascript:selectedDelvTab('D')">기본 배송지</button>
						      <button type="button" class="btn btn-default btn-outline" onclick="javascript:selectedDelvTab('N')">신규 배송지</button>
						    </div>
                            ...
                            <div class="col-md-12">
								<div class="card">
									<dl class="dl">
										...
										<dd><small>결제정보/주문상품/배송정보에 관한 문자가 발송됩니다.</small>
										    <input type="radio" name="receiveSms" id="receiveSms" value="true" checked>
										    <small>SMS 수신</small>
										    <input type="radio" name="unreceiveSms" id="unreceiveSms" value="false">
										    <small>SMS 수신안함</small>
										</dd>
								    </dl>
							    </div>
						    </div>
                            <div class="col-md-12">
								<div class="card">
									<dl class="dl">
										...
										<dd><input type="text" placeholder="부재 시 경비실에 맡겨주세요." class="form-control input-sm" name="delvMsg" id="delvMsg"></dd>
								    </dl>
							    </div>
						    </div>
                            <div class="col-md-12">
								<div class="card">
									<dl class="dl">
										...
										<hr class="m-b-10" />
            							<div class="row justify-content-center">
                                        	<div class="col-md-3" style="margin: auto;">사용 가능 포인트</div>
                                        	<div class="col-md-2" style="margin: auto;" name="availPoint" id="availPoint" >150 P</div>
                                            <div class="col-md-2" style="margin: auto;">
												<button type="submit" class="btn btn-info btn-sm" onclick="javascript:setAllPointAmt();">전액적용</button>
											</div>
                                            <div class="col-md-5" style="margin: auto;">
												<div class="form-group row" style="margin: auto;">
													<div class="input-group" style="margin: auto;">
														<input type="text" class="form-control input-sm" id="inPoint" placeholder="" onblur="checkPointAmt(); return false;">
														<div class="input-group-addon" style="margin: auto;">P</div>
													</div>
												</div>
											</div>
										</div>
                        ...
                        <div class="row align-items-center justify-content-center"> 
	                        <div class="col-auto"><button type="button" class="btn btn-primary btn-lg" onclick="window.location.href='${pageContext.request.contextPath}/OrderComplete'">결제하기</button></div>
	                        <div class="col-auto"><button type="button" class="btn btn-secondary btn-lg" onclick="window.location.href='${pageContext.request.contextPath}/CartList'">장바구니로 가기</button></div>
						</div>
                    </div>
                </div>
            </div>
