...
<link rel="icon" type="image/png" sizes="16x16"
	href="${pageContext.request.contextPath}/resources/images/minipark_logo.png">
...
<link rel="stylesheet" type="text/css"
	...
	rel="stylesheet" />
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/resources/css/helper.css">
<link rel="stylesheet" type="text/css"
...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/resources/css/tempStyle.css" />
...
<body class="fix-header fix-sidebar">
	...
	<div id="main-wrapper">
			...
			<nav class="navbar top-navbar navbar-expand-md navbar-light">
				...
				<div class="navbar-header">
					<a class="navbar-brand" href="${pageContext.request.contextPath}">
						<!-- Logo icon --> <b><img
							src="<c:url value="/resources/images/minipark_logo.png" />"
							alt="homepage" class="dark-logo" /></b> <!--End Logo icon --> <!-- Logo text -->
						<span><img
							src="<c:url value="/resources/images/minipark_logo-text.png" />"
					...
					<ul class="navbar-nav my-lg-0">
								...
								<ul>
									...
									<li>
										<div class="message-center">
											...
											<a href="#">
												<div class="user-img">
													<img src="<c:url value="/resources/images/users/5.jpg" />"
											...
											<a href="#">
												<div class="user-img">
													<img src="<c:url value="/resources/images/users/2.jpg" />"
														alt="user" class="img-circle"> <span
											...
											<a href="#">
												<div class="user-img">
													<img src="<c:url value="/resources/images/users/3.jpg" />"
														alt="user" class="img-circle"> <span
											...
											<a href="#">
												<div class="user-img">
													<img src="<c:url value="/resources/images/users/4.jpg" />"
														alt="user" class="img-circle"> <span
						...
						<li class="nav-item dropdown"><a
							...
							data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
								src="<c:url value="/resources/images/users/5.jpg" />" alt="user"
								class="profile-pic" /></a>
									...
									<form>
										<div class="form-group">
											<div class="input-group input-group-default">
												<input type="text" placeholder="주문 관련 검색" name="Search"
							...
							<div class="table-responsive">
								<table class="table table-striped">
									...
									<tbody>
										<tr>
											<th scope="row">1</th>
											<td><a data-toggle="modal" href="#myModal">20180618000000000001</a></td>
											<td><span class="badge badge-primary">과자</span></td>
											<td>1개</td>
											<td class="color-primary">2000원</td>
											<td>2017-06-18</td>
										</tr>
										<tr>
											<th scope="row">2</th>
											<td>20170618000000000002</td>
											<td><span class="badge badge-primary">사탕</span></td>
											<td>1개</td>
											<td class="color-primary">2000원</td>
											<td>2017-06-18</td>
										</tr>
										<tr>
											<th scope="row">3</th>
											<td>20170618000000000003</td>
											<td><span class="badge badge-primary">음료수</span></td>
											<td>1개</td>
											<td class="color-primary">2000원</td>
											<td>2017-06-18</td>
										</tr>
		...
		<!-- Amchart -->
		<script
			src="<c:url value="/resources/js/lib/morris-chart/raphael-min.js" />"></script>
		<script
			src="<c:url value="/resources/js/lib/morris-chart/morris.js" />"></script>
		<script
			src="<c:url value="/resources/js/lib/morris-chart/dashboard1-init.js" />"></script>


		<script
			src="<c:url value="/resources/js/lib/calendar-2/moment.latest.min.js" />"></script>
		<!-- scripit init-->
		<script
			src="<c:url value="/resources/js/lib/calendar-2/semantic.ui.min.js" />"></script>
		<!-- scripit init-->
		<script
			src="<c:url value="/resources/js/lib/calendar-2/prism.min.js" />"></script>
		<!-- scripit init-->
		<script
			src="<c:url value="/resources/js/lib/calendar-2/pignose.calendar.min.js" />"></script>
		<!-- scripit init-->
		<script
			src="<c:url value="/resources/js/lib/calendar-2/pignose.init.js" />"></script>

		<script
			src="<c:url value="/resources/js/lib/owl-carousel/owl.carousel.min.js" />"></script>
		<script
			src="<c:url value="/resources/js/lib/owl-carousel/owl.carousel-init.js" />"></script>
