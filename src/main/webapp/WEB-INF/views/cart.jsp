        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Cart</h3> </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-center"><span class="badge badge-primary">sale</span></td>
                                                <td class="color-primary text-center">$21.56</td>
                                                <td><form class="form-inline justify-content-center">
                                                	...
                                                	<button type="button" class="btn btn-dark btn-outline btn-xs">Change</button>
                                                	</div>
                                                </form></td>
                                                <td class="text-center"><button type="button" class="btn btn-dark btn-outline btn-xs">Order</button></td>
                                            </tr>
                                            <tr>
                                                <td class="text-center"><input id="checkbox1" type="checkbox"/></td>
                                                <td class="text-center">Kolor Tea Shirt For Women</td>
                                                <td class="text-center"><span class="badge badge-success">discount</span></td>
                                                <td class="color-success text-center">$55.32</td>
                                                <td><form class="form-inline justify-content-center">
                                                	<div class="form-group">
                                                	<label class="sr-only" for="Q1">Q1</label>
                                                	<input type="text" class="form-control input-sm"/>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><span class="badge badge-danger">sold-out</span></td>
                                                <td class="color-danger text-center">$14.85</td>
                                                <td><form class="form-inline justify-content-center">
                                                	<div class="form-group">
                                                	<label class="sr-only" for="Q1">Q1</label>
                                                	<input type="text" class="form-control input-sm"/>
                            ...
                            <div class="col-auto">Selected products</div>
                            <div class="col-auto"><input class="btn btn-primary" type="submit" value="Order"></div>
                            <div class="col-auto"><input class="btn btn-secondary" type="submit" value="Delete"></div>
							</div>
                        </div>
                    </div>
                </div>
